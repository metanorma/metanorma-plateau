       ...
       <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
         ...
         <sections>
           ...
           <clause id="H" obligation="normative" displayorder="8">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="H">2</semx></fmt-xref-label>
             <terms id="I" obligation="normative">
           ...
           <definitions id="L" displayorder="9">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="L">3</semx></fmt-xref-label>
             <dl>
               <dt>Symbol</dt>
               <dd>Definition</dd>
             </dl>
           ...
           <clause id="M" inline-header="false" obligation="normative" displayorder="10">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="M">4</semx></fmt-xref-label>
             <clause id="N" inline-header="false" obligation="normative">
               <title id="_">Introduction</title>
               <fmt-title depth="2" id="_">
                 <span class="fmt-caption-label">
           ...
           <references id="R" normative="true" obligation="informative" displayorder="11">
             ...
             <fmt-xref-label><span class="fmt-element-name">箇条</span> <semx element="autonum" source="R">5</semx></fmt-xref-label>
           </references>
         </sections>
