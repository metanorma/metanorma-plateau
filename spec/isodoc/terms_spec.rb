...
RSpec.describe IsoDoc::Plateau do
  ...
  it "renders different types of termsource" do
    input = <<~INPUT
      <metanorma xmlns="https://www.metanorma.org/ns/standoc" type="semantic" version="3.2.0" schema-version="v2.1.3" flavor="plateau">
          ...
          <term id="term-Term-1" anchor="term-Term-1">
             ...
             <fmt-termsource status="identical" type="authoritative">
                ...
                <semx element="source" source="_">
                   ...
                   <semx element="origin" source="_">
                      <fmt-xref type="inline" style="reference-tag" target="internet_standards">
                         [3],
          ...
          <term id="term-Term-2" anchor="term-Term-2">
             ...
             <fmt-termsource status="identical" type="authoritative">
                ...
                <semx element="source" source="_">
                   ...
                   <semx element="origin" source="_">
                      <fmt-xref type="inline" style="reference-tag" target="graphql">
                         [4],
                         <span class="citesec">Clause 3</span>
                      </fmt-xref>
                   </semx>
                ...
                <semx element="source" source="_">
                   ...
                   <semx element="origin" source="_">
                      <fmt-xref type="inline" style="reference-tag" target="iso643">ISO 643,
                         <span class="citesec">Clause 3</span>
                      </fmt-xref>
                   </semx>
                </semx>
                ...
                <semx element="source" source="_">
                   ...
                   <semx element="origin" source="_">
                      <fmt-xref type="inline" style="reference-tag" target="ietf643">IETF RFC 643,
                         <span class="citesec">Clause 3</span>
                      </fmt-xref>
                   </semx>
                </semx>
          ...
          <term id="term-Term-3" anchor="term-Term-3">
             ...
             <fmt-termsource status="identical" type="authoritative">
                ...
                <semx element="source" source="_">
                   ...
                   <semx element="origin" source="_">
                      <fmt-xref type="inline" style="reference-tag" target="ihos49">IHO S-49,
                        <span class="citesec">Clause 3</span>
                      </fmt-xref>
                   </semx>
                </semx>
